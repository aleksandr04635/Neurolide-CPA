...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-2 bg-black/50  data-[state=open]:animate-in data-[state=closed]:animate-out " +
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-2 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 " +
