  ...
  return (
    <nav className="flex flex-col w-full max-w-[250px] gap-1">
      <Link
        href="/main"
        className={
          "flex md:hidden flex-row items-center  py-1 px-3 bg-white rounded-lg w-full hover:bg-accent " +
          (pathname === "/main" ? " text-black    " : " text-gray-text")
        }
      >
        <div
          className={
            "flex items-center justify-center w-[30px] h-[24px] rounded-lg mr-2 " +
            (pathname === "/main" ? " bg-blue-icon-bg " : " ")
          }
        >
          <svg
            width="20"
