...
flex flex-row items-center justify-between h-fit w-full py-2 pl-3 pr-6"
      >
        ...
        <div className=" flex flex-row items-center justify-start  w-fit    gap-3   ">
          ...
          <div className=" text-white font-bold text-[20px] w-fit">
            Neurolide
          </div>
        </div>
      ...
      {pathname === "/main" && (
        <div
          className=" bg-gradient-to-b from-blue-from via-blue-via to-blue-to
        md:hidden flex flex-row items-center justify-center gap-2 h-fit w-full py-2 px-3"
        >
          <svg
            width="20"
            height="20"
      ...
      {pathname === "/" && (
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            className={pathname === "/" ? " stroke-white" : " stroke-gray-icon"}
          >
            <path
      ...
      {pathname === "/users" && (
        ...
        >
          <svg
            className={
              "pb-[2px] pr-[2px] " +
              (pathname === "/users" ? "  stroke-white" : "  stroke-gray-icon")
            }
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          <div className="text-white text-sm font-light  ">Користувачі</div>
        </div>
      )}
      ...
      {pathname === "/created-offers" && (
        ...
        >
          ...
          <div className="text-white text-sm font-light  "> Додані офери</div>
        </div>
      )}
      ...
      {pathname === "/offers-in-work" && (
        ...
        >
          ...
          <div className="text-white text-sm font-light  "> Офери у роботі</div>
        </div>
      )}
      ...
      {pathname === "/media-channels" && (
        ...
        >
          ...
          <div className="text-white text-sm font-light  ">Медіа канали</div>
        </div>
      )}
      ...
      {pathname === "/offers" && (
        ...
        >
          <svg
            className={
              /* "pb-[2px] pr-[2px] " + */
              pathname === "/offers" ? "  stroke-white" : "  stroke-gray-icon"
            }
            width="18"
            height="18"
            viewBox="0 0 18 18"
          ...
          <div className="text-white text-sm font-light  "> Офери</div>
        </div>
      )}
      ...
      {pathname === "/profile" && (
        ...
        >
          <svg
            className={
              /* "pb-[2px] pr-[2px] " + */
              pathname === "/profile" ? "  stroke-white" : "  stroke-gray-icon"
            }
            width="16"
            height="16"
            viewBox="0 0 16 16"
          ...
          <div className="text-white text-sm font-light  ">Профіль</div>
        </div>
      )}
      ...
      {pathname === "/balance" && (
        ...
        >
          <svg
            className={
              /* "pb-[2px] pr-[2px] " + */
              pathname === "/balance" ? "  stroke-white" : "  stroke-gray-icon"
            }
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          <div className="text-white text-sm font-light  "> Баланс</div>
        </div>
      )}
